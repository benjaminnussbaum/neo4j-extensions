 ...
 *
 */
public class ZeroMqInboundChannelAdapterParser extends AbstractPollingInboundChannelAdapterParser {
	@Override
	protected BeanMetadataElement parseSource(final Element element, final ParserContext parserContext) {
		...
		final String kafkaConsumerContext = element.getAttribute("zeromq-consumer-context-ref");
